// Package e2e contains the conductor end-to-end test suite.
//
// These tests verify the signing loop artifact storage, PackInstance pull loop
// signature verification, and PermissionSnapshot pull loop on live clusters.
//
...
func TestE2E(t *testing.T) {
	...
	RunSpecs(t, "conductor E2E Suite")
}
